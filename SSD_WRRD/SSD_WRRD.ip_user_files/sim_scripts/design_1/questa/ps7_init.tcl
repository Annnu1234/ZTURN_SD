...
proc ps7_clock_init_data_3_0 {} {
    ...
    mask_write 0XF8000140 0x03F03F71 0x00100821
...
proc ps7_mio_init_data_3_0 {} {
    ...
    mask_write 0XF8000830 0x003F003F 0x002E0037
    mwr -force 0XF8000004 0x0000767B
}
proc ps7_peripherals_init_data_3_0 {} {
    ...
    mask_write 0XE000A00C 0x003F003F 0x00370008
    mask_write 0XE000A204 0xFFFFFFFF 0x00000001
    mask_write 0XE000A000 0xFFFFFFFF 0xFFFE0001
    mask_write 0XE000A208 0xFFFFFFFF 0x00000001
    mask_write 0XE000A000 0xFFFFFFFF 0xFFFE0000
    mask_delay 0XF8F00200 1
    mask_write 0XE000A000 0xFFFFFFFF 0xFFFE0001
}
